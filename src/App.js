    ...
    return (
      <Navbar>
        <nav className='navbar navbar-expand announcement'>
          <p>
            UPCOMING CONFERENCE: How to use Access Manager to it's fullest
            potential. <a href='/'>Grab a seat in the Virtual Classroom</a>
          </p>
        </nav>
        <nav className='navbar navbar-expand'>
          <div className='logo'>
            <a href='/home'>
              <img
                src='https://s3.us-east-2.amazonaws.com/fiservseminars-media.com/logo.png'
                height='84px'
                alt='logo'
              ></img>
            </a>
        ...
        <nav className='navbar-nav-scroll authentication'>
          ...
          {isAuthenticated() && (
            <Button
              className='btn-margin'
              onClick={this.goTo.bind(this, 'notes')}
            >
              Notes
            </Button>
          )}
